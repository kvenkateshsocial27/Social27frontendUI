...
String BL_Customization1 = BL_Customization1
String BL_Customization2 = BL_Customization2
String BL_Customization3 = BL_Customization3
...
CustomKeywords.'com.kf.verifymenu.checkaccess'("Rountables", BL_Roundtables, URLname, GlobalOutputfile, Rowno, columnstart+8)
...
String AL_Customization1 = AL_Customization1
String AL_Customization2 = AL_Customization2
String AL_Customization3 = AL_Customization3
...
//CustomKeywords.'com.kf.verifymenu.landingpage'(LandingPage, URLname, URLname)
...
/*
CustomKeywords.'com.kf.verifymenu.checkaccess'("Signin",  BL_SignIn, URLname, GlobalOutputfile, Rowno, 8)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Signup", BL_Signup, URLname, GlobalOutputfile, Rowno, 9)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Home", BL_Home, URLname, GlobalOutputfile, Rowno, 10)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Sessions", BL_Sessions, URLname, GlobalOutputfile, Rowno, 11)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Speakers",  BL_Speakers, URLname, GlobalOutputfile, Rowno, 12)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Sponsors", BL_Sponsors, URLname, GlobalOutputfile, Rowno, 13)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Networking", BL_Networking, URLname, GlobalOutputfile, Rowno, 14)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Notifications", BL_Notifications, URLname, GlobalOutputfile, Rowno, 15)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Rountables", BL_Roundtables, URLname, GlobalOutputfile, Rowno, 16)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Profile", BL_MyProfile, URLname, GlobalOutputfile, Rowno, 17)
CustomKeywords.'com.kf.verifymenu.checkaccess'("MyAgenda", BL_MyAgenda, URLname, GlobalOutputfile, Rowno, 18)
CustomKeywords.'com.kf.verifymenu.checkaccess'("Logout", BL_Logout, URLname, GlobalOutputfile, Rowno, 19)
